    ...
    <div className="navbar bg-base-200 justify-between">
      ...
      <div className="flex justify-between">
        ...
        <div className="dropdown dropdown-end mr-5">
          <div tabIndex={3} className="btn btn-ghost btn-circle">
            <div className="indicator">
              <span className="indicator-item badge badge-secondary">8</span>
              <button type="button" className='btn glass'>My Cart</button>
            </div>
          </div>
          <div tabIndex={4} className="dropdown-content mt-3 z-[1] card card-compact w-52 bg-base-100 shadow">
        ...
        <div className="dropdown dropdown-end ml-5">
          <label tabIndex={5} className="btn btn-ghost btn-circle avatar">
            <div className="w-10 rounded-full">
              {
                user ? <img src={user.photoUrl} alt='' /> : <FaUserCircle size='2em'></FaUserCircle>
              }

            </div>
          </label>
          <div tabIndex={4} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
            <div className="card-body">
              <span className="font-bold text-lg">8 Items</span>
              <div className="card-actions">
                <button className="btn btn-secondary btn-block"><NavLink to={'/mycart'}>Log Out</NavLink></button>
              </div>
            </div>
          </div>
        </div>
